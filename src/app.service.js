...
var AppService = function () {
    ...
    var AppService = _classThis = /** @class */ (function () {
        function AppService_1(usuarioService) {
         ...
         */
        AppService_1.prototype.onApplicationBootstrap = function () {
            return __awaiter(this, void 0, void 0, function () {
                var EMAIL, existe, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            EMAIL = 'diretoria@admin.com';
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 5, , 6]);
                            return [4 /*yield*/, this.usuarioService.findByUsuario(EMAIL)];
                        case 2:
                            existe = _a.sent();
                            if (!!existe) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.usuarioService.create({
                                    nome: 'Diretoria',
                                    usuario: EMAIL,
                                    senha: 'Diretoria@!321',
                                    tipo: 'admin',
                        ...
                        case 5:
                            err_1 = _a.sent();
                            console.error('Erro ao criar admin padrão:', err_1);
                            return [3 /*break*/, 6];
